...
class _HealthProfileEditScreenState extends State<HealthProfileEditScreen> {
  ...
  Future<void> _saveProfile() async {
    ...
    try {
      ...
      if (widget.profile == null) {
        // TODO: Fix - createHealthProfile expects HealthProfile object, not Map
        // await provider.createHealthProfile(HealthProfile(...));
        throw UnimplementedError('Create profile not yet implemented');
      } else {
        // TODO: Fix - updateHealthProfile expects HealthProfile object, not Map
        // await provider.updateHealthProfile(widget.profile!.copyWith(...));
